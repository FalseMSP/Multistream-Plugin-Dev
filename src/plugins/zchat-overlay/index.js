...
const { buildSegments } = require('../../chat-emotes');
...
// buildSegments/parseTwitchEmotesTag now live in ../../chat-emotes so the
// dashboard chat column can produce identical emote segments — see that
